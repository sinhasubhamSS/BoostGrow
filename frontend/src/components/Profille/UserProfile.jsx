...
import { addFollower, removeFollower } from '../../Redux/friendSlice';
...
function UserProfile({ userId }) {
    ...
    const followers = useSelector(state => state.friend.followers || []);
        ...
        <>
            <div className="profile_container">
                ...
                <div className="profile_counts">
                    <p><strong>{followers?.length || 0}</strong>followers</p>
                    <p><strong>{following?.length || 0}</strong>following</p>
                </div>
